      ...
      <div className="left w-[20vw] h-screen border text-white bg-gray-600 border-black z-10 flex justify-center">
        <div className="account flex flex-col justify-center">
          ...
          <div className="details mx-auto mt-5 text-base font-normal p-5 grid gap-3">
            <h2>Name of Organisation: <br /> Haldwani City Blood Centre</h2>
            <h2>Registration Number: <br /> 12666644</h2>
            <h2>License Number: <br /> 342342524</h2>
            <h2>Email Address: <br /> bloodbank212@gmail.com</h2>
            <h2>Phone Number: <br /> 8789964455</h2>
            <h2>Address: <br /> 6GGJ+8F4, Thandi Sadak, Subhash Nagar, Haldwani, Uttarakhand 263139</h2>
          </div>
      ...
      <div className="right h-[100vh] w-[80vw]">
        <div className="head w-[80vw] h-[15vh] bg-red-500 top-0 flex fixed right-0 justify-around py-6">
          ...
          <div className="options p-2">
            <select name="" id="" className="p-2 font-medium text-base rounded-md">
          ...
          <table className="w-[70vw]">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border border-gray-300 px-4 py-2">Name of Donor</th>
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 px-auto py-2 text-center">
                  <button className="bg-green-500 text-white px-4 py-1 rounded mr-10">Accept</button>
